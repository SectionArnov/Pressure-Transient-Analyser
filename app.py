...
porosity = st.sidebar.number_input('Enter Porosity(∅)', value=0.0)
viscosity = st.sidebar.number_input('Enter Fluid Viscosity(μ)', value=0.0)
FVF = st.sidebar.number_input('Enter Formation Volume Factor(B)', value=0.0)
ct = st.sidebar.number_input('Enter Total Compressibility(ct)', value=0.0, format="%f")
h = st.sidebar.number_input('Enter Pay Zone Thickness(h)', value=0.0)
rw = st.sidebar.number_input('Enter Wellbore Radius(rw)', value=0.0)
q = st.sidebar.number_input('Enter Flow Rate(q)', value=0.0)
