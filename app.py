...
h = st.sidebar.number_input('Enter Pay Zone Thickness(h) (ft)', value=0.0)
rw = st.sidebar.number_input('Enter Wellbore Radius(rw) (ft)', value=0.0)
q = st.sidebar.number_input('Enter Flow Rate(q) (bbl/d)', value=0.0)
